...
const EditCar = ({cardata}:FormProps) => {
  ...
  return (
    ...
    <Dialog open={open} onClose={handleClose}>
     ...
     <DialogActions>
    <Button variant="contained" color="error"  onClick={handleClose}> Cancel<CancelIcon color="error" /> </Button>
    <Button variant="contained" color="primary"  onClick={handleSave}> Save<SaveIcon color="primary" /></Button>
    </DialogActions>
